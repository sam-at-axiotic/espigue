...
mod tests {
    ...
    ///
    /// Run with: `S2_API_KEY=<your-key> cargo test -p search --lib -- s2_api_key_flows_to_client --ignored`
    #[test]
    #[ignore = "requires S2_API_KEY exported in the shell env — run manually: cargo test -p search --lib -- s2_api_key_flows_to_client --ignored"]
