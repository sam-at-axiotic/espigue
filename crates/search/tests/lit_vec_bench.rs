...
/// Run manually:
/// ```text
/// cargo test -p search --test lit_vec_bench bench_lit_vec_10k -- --ignored --nocapture --release
/// ```
#[tokio::test]
#[ignore = "10k benchmark — run: cargo test -p search --test lit_vec_bench bench_lit_vec_10k -- --ignored --nocapture --release"]
