...
//! It lives in `base` so any crate can reference it without pulling
...
pub enum AlzinaEvent {
    ...
    ///
    /// Lives in `base` because it is a protocol-level event — it records
...
///
/// Source: `crates/orchestration/src/composition/parser/render.rs`
