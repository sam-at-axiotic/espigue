...
//!       cargo run -p litreview-cli --example live_smoke`
...
use litreview_cli::openrouter::embeddings::{
    OpenRouterEmbeddingService, DEFAULT_DIMENSIONS, DEFAULT_MODEL,
};
use litreview_cli::openrouter::executor::OpenRouterExecutor;
use litreview_cli::openrouter::rerank::openrouter_reranker;
