...
pub async fn persist_chunks_for_paper(
    ...
    embedder: &dyn alzina_core::search::EmbeddingService,
    paper_id: &str,
    source_type: &str,
    title: &str,
    ...
    use alzina_core::search::{EmbeddingTask, VectorMetadata, VectorStore};
...
pub async fn persist_arxiv_abstract(
    ...
    embedder: &dyn alzina_core::search::EmbeddingService,
    meta: &ArxivResult,
) -> alzina_core::error::AlzinaResult<()> {
...
mod staged_ingest {
    ...
    impl alzina_core::search::EmbeddingService for StubEmbedder {
        async fn embed(
            &self,
            _text: &str,
            _task: alzina_core::search::EmbeddingTask,
        ...
        async fn embed_batch(
            &self,
            texts: &[String],
            task: alzina_core::search::EmbeddingTask,
...
mod promote_pdf {
    ...
    async fn missing_binary_names_path_in_error() {
        ...
        match err {
            alzina_core::error::AlzinaError::Search(d) => {
                assert!(d.degraded);
                assert!(
