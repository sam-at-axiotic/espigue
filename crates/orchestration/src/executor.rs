...
use base::identity::{AgentId, SessionId};
use base::{AlzinaEvent, AlzinaResult};
...
pub trait AgentExecutor: Send + Sync {
    ...
    /// `return_envelope` `CustomToolDefinition` (`orchestration::
    ...
    ) -> AlzinaResult<(String, Option<base::Envelope>)> {
        let raw = self
