...
mod tests {
    ...
    use search::bib_store::{BibEntry, BibliographyStore, NoopBibliographyStore};
  ...
  <uncertainties>
    ...
    /// dedup behaviour itself is covered by search's bib_store tests; here
    ...
    mod f2_in_loop_error_propagation {
        ...
        async fn f2_retrieval_runs_all_gaps_then_propagates_first_err() {
            ...
            let machine = TtdMachine {
                ...
                executor: make_executor(Arc::new(AtomicUsize::new(0))),
                bib_store: Arc::new(search::bib_store::NoopBibliographyStore),
                run_id: String::new(),
                stage_label: "test".to_string(),
            };
