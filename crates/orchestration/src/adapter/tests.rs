...
//! is #[cfg(test)]-gated in search and NOT importable cross-crate).

use super::build_panel;
use search::lit_schema::{migrate, upsert_paper};
...
fn make_fused_hit(paper_id: &str) -> search::lit_fusion::FusedHit {
    search::lit_fusion::FusedHit {
